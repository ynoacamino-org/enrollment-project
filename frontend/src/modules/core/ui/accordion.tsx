...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      {...props}
    >
      <div className={cn('pt-2 pb-4 px-6', className)}>{children}</div>
    </AccordionPrimitive.Content>
  );
}
